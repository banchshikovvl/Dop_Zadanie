...
print(students1)
balAa = sum(grades[0])/len(grades[0])
balBi = sum(grades[1])/len(grades[1])
balJo = sum(grades[2])/len(grades[2])
balKh = sum(grades[3])/len(grades[3])
balSt = sum(grades[4])/len(grades[4])
my_list = (balAa,balBi,balJo,balKh,balSt)
my_dict = dict(zip(students1, my_list))
print(my_dict)
